...
CREATE TABLE public.individual (
	...
	CONSTRAINT created_date_check_3 CHECK (created_date <= CURRENT_TIMESTAMP),
	CONSTRAINT updated_date_check_3 CHECK (updated_date <= CURRENT_TIMESTAMP)
);
CREATE TABLE public.card (
	...
	CONSTRAINT created_date_check_4 CHECK (created_date <= CURRENT_TIMESTAMP),
	CONSTRAINT updated_date_check_4 CHECK (updated_date <= CURRENT_TIMESTAMP),
