...
CREATE TABLE public.legal_entity (
	...
	CONSTRAINT created_date_check_1 CHECK (created_date <= CURRENT_TIMESTAMP),
	CONSTRAINT updated_date_check_1 CHECK (updated_date <= CURRENT_TIMESTAMP),
...
CREATE TABLE public.account (
	...
	CONSTRAINT created_date_check_2 CHECK (created_date <= CURRENT_TIMESTAMP),
	CONSTRAINT updated_date_check_2 CHECK (updated_date <= CURRENT_TIMESTAMP),
